...
HRESULT InitDevice()
{
	...
	{
		{ XMFLOAT3(0.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },//0
		{ XMFLOAT3(0.0f, -4.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },//1
        { XMFLOAT3(1.0f, -4.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },//2
        { XMFLOAT3(1.0f, 2.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },//3
		{ XMFLOAT3(0.0f, 2.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },//4
		{ XMFLOAT3(-1.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },//5

        { XMFLOAT3(0.0f, 0.0f, -0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },//6
        { XMFLOAT3(0.0f, -4.0f, -0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },//7
        { XMFLOAT3(1.0f, -4.0f, -0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },//8
        { XMFLOAT3(1.0f, 2.0f, -0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },//9
        { XMFLOAT3(0.0f, 2.0f, -0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },//10
        { XMFLOAT3(-1.0f, 0.0f, -0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },//11
	};
    ...
    g_Projection2 = XMMatrixPerspectiveFovRH(XM_PIDIV4, width / (FLOAT)height, 0.01f, 500.0f);
    return S_OK;
}
